...
public class Query2 extends JFrame {
    ...
    private void showSQLStatement() {
        ...
        String formattedQuery ="Given a project number and a number of hours,\n"
        		+ "retrieve (if exists) the employee (Fname and Fname) \n"
        		+ "and the number of hours worked in the given Project \n"
        		+ "of the employee that works the highest number of hours \n"
        		+ "in the given project between those employees that work less \n"
        		+ "than the given number of hours in the given project. \n"
        		+ "Also retrieve (if exists) the same information for the employee \n"
        		+ "that works the lowest number of hours in the given project \n"
        		+ "between those employees that work more than the given number \n"
        		+ "of hours in the given project:\n\n\n" 
        		+ EMPLOYEE_HOURS_QUERY_TEMPLATE
            .replaceAll("\\?", "\\{param\\}")
