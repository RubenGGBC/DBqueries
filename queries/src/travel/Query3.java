...
public class Query3 extends JFrame {
    ...
    public Query3() {
        ...
        JTextArea statementText = new JTextArea(
            "This query shows various information for each tour guide: "
            + "their total amount of trips and customers served; their generated revenue, "
            + "calculated from the amount days they have been on each trip, the amount of "
            + "customers in said trips, and their price per day; and their spoken languages:"
        );
    ...
    private void showSQLStatement() {
        JTextArea textArea = new JTextArea("This query shows various information for each tour guide: \n"
                + "their total amount of trips and customers served; their generated revenue, \n"
                + "calculated from the amount days they have been on each trip, the amount of \n"
                + "customers in said trips, and their price per day; and their spoken languages: \n\n\n"
                + TOUR_GUIDE_QUERY);
